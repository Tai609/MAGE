...
def get_model(model: str = 'google_gemini-3-flash-preview', **kwargs: Any):
    """
    ...
    if provider == 'openai':
        ...
        try:
            ...
            llm = get_openai_model(model_name=official_model_name, **kwargs)
             ...
             raise ImportError("Could not import 'get_openai_model' from .openai_models. Ensure its dependencies are available.") from e
    ...
    # Add other providers here using the same pattern
        ...
        try:
            ...
            llm = get_google_model(model_name=official_model_name, **kwargs)
             ...
             raise ImportError("Could not import 'get_google_model' from .google_models. Ensure it exists and langchain-openai is installed.") from None
        except Exception as e:
