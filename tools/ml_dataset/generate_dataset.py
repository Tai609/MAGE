...
from prompts.extract_HER_prompt_v3_2 import ml_dataset_row_generation
# Import functions from sibling tools
from tools.cat_graph.extract_synthesis_trees import process_file as extract_trees
from tools.cat_graph.catgraph_to_txt import generate_catgraph_text
...
def generate_ml_dataset(combined_graph_file: Path, run_id: str, output_dir: Path, ml_model_name: str, ml_model: Any, feature_file_path: Path):
    ...
    final_dataset_file = final_dataset_dir / f"{run_id}_dataset.csv"
