...
This document outlines the Neo4j graph schema generated by the `MAGE/tools/neo4j/neo4j_import.py` script. The script processes JSON/JSON5 files containing catalysis experiment data (synthesis and testing) and imports them into a Neo4j database.
